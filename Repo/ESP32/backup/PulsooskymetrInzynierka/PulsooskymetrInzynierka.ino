...
#define USEFIFO
#define Port 80
const char* ssid = "FunBox2-7ADB";
const char* password = "FF5E7C3CA56222F92D2A153A57";
...
{
  Serial.println("_________Problem with wifi connect");
  delay(500);
}
Serial.println("YAY");
...
//if(client){
//  Serial.println("Hi client");
//  //while(1){
//    while(client.available()){
      uint8_t mark = client.read();
      switch(mark)
      {
        case 'a':
          client.println(" ");
